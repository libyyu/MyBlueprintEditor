...
IMGUI_NODE_EDITOR_API void NavigateToRect(const ImVec2& boundsMin, const ImVec2& boundsMax, bool zoomIn = false, float duration = -1);
IMGUI_NODE_EDITOR_API void NavigateToRectExact(const ImVec2& boundsMin, const ImVec2& boundsMax, float duration = -1);
