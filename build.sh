...
if [ "$BLUEPRINT_LUA" = "OFF" ]; then
    BLUEPRINT_LUASOCKET="OFF"
    BLUEPRINT_LINK_XLUA="OFF"
fi
...
case "$PLATFORM" in
    linux|macos)
        CMAKE_EXTRA_ARGS="-DCMAKE_BUILD_TYPE=${BUILD_TYPE} -DBUILD_EXAMPLES=${BUILD_EXAMPLES} -DBUILD_SHARED_LIBS=${BUILD_SHARED} -DBUILD_MACOS_BUNDLE=${BUILD_MACOS_BUNDLE} -DRUNTIME_NAME=${RUNTIME_NAME} -DBLUEPRINT_LUA=${BLUEPRINT_LUA} -DLUA_LINK_STATIC=${LUA_LINK_STATIC} -DBLUEPRINT_PROTOBUF=${BLUEPRINT_PROTOBUF} -DBLUEPRINT_LUASOCKET=${BLUEPRINT_LUASOCKET} -DBUILD_BUNDLE=${BUILD_BUNDLE} -DBUNDLE_LUA=${BUNDLE_LUA} -DBUNDLE_PROTOBUF=${BUNDLE_PROTOBUF} -DBLUEPRINT_LINK_XLUA=${BLUEPRINT_LINK_XLUA} -DBUNDLE_LUASOCKET=${BUNDLE_LUASOCKET}"
        ;;
    ...
    runtime)
        RUNTIME_ONLY="ON"
        CMAKE_EXTRA_ARGS="-DCMAKE_BUILD_TYPE=${BUILD_TYPE} -DBUILD_RUNTIME_ONLY=ON -DBUILD_SHARED_LIBS=${BUILD_SHARED} -DBUILD_EXAMPLES=${BUILD_EXAMPLES} -DRUNTIME_NAME=${RUNTIME_NAME} -DBLUEPRINT_LUA=${BLUEPRINT_LUA} -DLUA_LINK_STATIC=${LUA_LINK_STATIC} -DBLUEPRINT_PROTOBUF=${BLUEPRINT_PROTOBUF} -DBLUEPRINT_LUASOCKET=${BLUEPRINT_LUASOCKET} -DBUILD_BUNDLE=${BUILD_BUNDLE} -DBUNDLE_LUA=${BUNDLE_LUA} -DBUNDLE_PROTOBUF=${BUNDLE_PROTOBUF} -DBLUEPRINT_LINK_XLUA=${BLUEPRINT_LINK_XLUA}  -DBUNDLE_LUASOCKET=${BUNDLE_LUASOCKET}"
        ;;

    windows-dll)
        find_mingw_toolchain
        BUILD_SHARED="ON"
        CMAKE_EXTRA_ARGS="-DCMAKE_BUILD_TYPE=${BUILD_TYPE} -DCMAKE_SYSTEM_NAME=Windows -DCMAKE_C_COMPILER=${MINGW_PREFIX}-gcc -DCMAKE_CXX_COMPILER=${MINGW_PREFIX}-g++ -DCMAKE_RC_COMPILER=${MINGW_PREFIX}-windres -DBUILD_SHARED_LIBS=ON -DBUILD_EXAMPLES=${BUILD_EXAMPLES} -DRUNTIME_NAME=${RUNTIME_NAME} -DBLUEPRINT_LUA=${BLUEPRINT_LUA} -DLUA_LINK_STATIC=${LUA_LINK_STATIC} -DBLUEPRINT_PROTOBUF=${BLUEPRINT_PROTOBUF} -DBLUEPRINT_LUASOCKET=${BLUEPRINT_LUASOCKET} -DBUILD_BUNDLE=${BUILD_BUNDLE} -DBUNDLE_LUA=${BUNDLE_LUA} -DBUNDLE_PROTOBUF=${BUNDLE_PROTOBUF} -DBLUEPRINT_LINK_XLUA=${BLUEPRINT_LINK_XLUA} -DBUNDLE_LUASOCKET=${BUNDLE_LUASOCKET}"
        ;;
    ...
    android)
        ...
        CMAKE_EXTRA_ARGS="-DCMAKE_TOOLCHAIN_FILE=${NDK_PATH}/build/cmake/android.toolchain.cmake -DANDROID_ABI=arm64-v8a -DANDROID_PLATFORM=android-${ANDROID_API} -DBUILD_RUNTIME_ONLY=ON -DBUILD_SHARED_LIBS=${BUILD_SHARED} -DBUILD_EXAMPLES=OFF -DCMAKE_BUILD_TYPE=${BUILD_TYPE} -DRUNTIME_NAME=${RUNTIME_NAME} -DBLUEPRINT_LUA=${BLUEPRINT_LUA} -DLUA_LINK_STATIC=${LUA_LINK_STATIC} -DBLUEPRINT_PROTOBUF=${BLUEPRINT_PROTOBUF} -DBLUEPRINT_LUASOCKET=${BLUEPRINT_LUASOCKET} -DBUILD_BUNDLE=${BUILD_BUNDLE} -DBUNDLE_LUA=${BUNDLE_LUA} -DBUNDLE_PROTOBUF=${BUNDLE_PROTOBUF} -DBUNDLE_LUASOCKET=${BUNDLE_LUASOCKET} -DBLUEPRINT_LINK_XLUA=${BLUEPRINT_LINK_XLUA}"
        ;;
    ...
    ios)
        ...
        LUA_LINK_STATIC="OFF"
        CMAKE_EXTRA_ARGS="${IOS_TC_ARG} -DCMAKE_SYSTEM_NAME=iOS -DCMAKE_OSX_ARCHITECTURES=arm64 -DCMAKE_OSX_DEPLOYMENT_TARGET=13.0 -DBUILD_RUNTIME_ONLY=ON -DBUILD_SHARED_LIBS=OFF -DBUILD_EXAMPLES=OFF -DCMAKE_BUILD_TYPE=${BUILD_TYPE} -G Xcode  -DRUNTIME_NAME=${RUNTIME_NAME} -DBLUEPRINT_LUA=${BLUEPRINT_LUA} -DLUA_LINK_STATIC=OFF -DBLUEPRINT_PROTOBUF=${BLUEPRINT_PROTOBUF} -DBLUEPRINT_LUASOCKET=${BLUEPRINT_LUASOCKET} -DBUILD_BUNDLE=${BUILD_BUNDLE} -DBUNDLE_LUA=${BUNDLE_LUA} -DBUNDLE_PROTOBUF=${BUNDLE_PROTOBUF} -DBUNDLE_LUASOCKET=${BUNDLE_LUASOCKET} -DBLUEPRINT_LINK_XLUA=${BLUEPRINT_LINK_XLUA}"
        ;;
    *)
