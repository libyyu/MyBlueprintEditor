...
public:
	// Set a custom LanguageDefinition (defined in private section above).
	// Pass nullptr to disable custom language.
	void SetCustomLanguageDefinition(const LanguageDefinition* aLangDef);
public:
