...
// SetCustomLanguageDefinition: allows passing an arbitrary LanguageDefinition struct
// instead of a built-in LanguageDefinitionId enum value.
void TextEditor::SetCustomLanguageDefinition(const LanguageDefinition* aLangDef)
{
    mLanguageDefinition   = aLangDef;
