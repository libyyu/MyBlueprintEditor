...
static void qpsetup(UChar *c, UChar *unbase);
...
\*-------------------------------------------------------------------------*/
static UChar qpclass[256];
static UChar qpbase[] = "0123456789ABCDEF";
static UChar qpunbase[256];
...
static void qpsetup(UChar *cl, UChar *unbase)
{
    ...
    cl[(UChar)('\t')] = (UChar)QP_IF_LAST;
    cl[(UChar)(' ')] = (UChar)QP_IF_LAST;
    cl[(UChar)('\r')] = (UChar)QP_CR;
    for (i = 0; i < 256; i++) unbase[i] = (UChar)255;
    unbase[(UChar)('0')] = (UChar)0; unbase[(UChar)('1')] = (UChar)1; unbase[(UChar)('2')] = (UChar)2;
    unbase[(UChar)'3'] = (UChar)3; unbase[(UChar)'4'] = (UChar)4; unbase[(UChar)'5'] = (UChar)5;
    unbase[(UChar)'6'] = (UChar)6; unbase[(UChar)'7'] = (UChar)7; unbase[(UChar)'8'] = (UChar)8;
    unbase[(UChar)'9'] = (UChar)9; unbase[(UChar)'A'] = (UChar)10; unbase[(UChar)'a'] = (UChar)10;
    unbase[(UChar)'B'] = (UChar)11; unbase[(UChar)'b'] = (UChar)11; unbase[(UChar)'C'] = (UChar)12;
    unbase[(UChar)'c'] = (UChar)12; unbase[(UChar)'D'] = (UChar)13; unbase[(UChar)'d'] = (UChar)13;
    unbase[(UChar)'E'] = (UChar)14; unbase[(UChar)'e'] = (UChar)14; unbase[(UChar)'F'] = (UChar)15;
    unbase[(UChar)'f'] = (UChar)15;
}
