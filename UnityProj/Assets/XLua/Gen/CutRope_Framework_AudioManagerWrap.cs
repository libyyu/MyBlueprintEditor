...
namespace XLua.CSObjectWrap
{
    ...
    public class CutRopeFrameworkAudioManagerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(CutRope.Framework.AudioManager);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new CutRope.Framework.AudioManager();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to CutRope.Framework.AudioManager constructor!");
        ...
        static int _m_PlaySFX(RealStatePtr L)
        {
		    try {
                ...
                CutRope.Framework.AudioManager gen_to_be_invoked = (CutRope.Framework.AudioManager)translator.FastGetCSObj(L, 1);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to CutRope.Framework.AudioManager.PlaySFX!");
        ...
        static int _m_PlayBGM(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to CutRope.Framework.AudioManager.PlayBGM!");
        ...
        static int _m_StopBGM(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to CutRope.Framework.AudioManager.StopBGM!");
        ...
        static int _g_get_Instance(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, CutRope.Framework.AudioManager.Instance);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
