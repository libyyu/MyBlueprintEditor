...
namespace XLua.CSObjectWrap
{
    ...
    public class UGFrameworkRuntimeUGUIPanelBackendWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UGFramework.Runtime.UGUIPanelBackend);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<UnityEngine.GameObject>(L, 2))
				{
					...
					var gen_ret = new UGFramework.Runtime.UGUIPanelBackend(_root);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UGFramework.Runtime.UGUIPanelBackend constructor!");
        ...
        static int _m_SetVisible(RealStatePtr L)
        {
		    try {
                ...
                UGFramework.Runtime.UGUIPanelBackend gen_to_be_invoked = (UGFramework.Runtime.UGUIPanelBackend)translator.FastGetCSObj(L, 1);
