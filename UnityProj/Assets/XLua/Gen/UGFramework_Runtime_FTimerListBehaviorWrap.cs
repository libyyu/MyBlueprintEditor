...
namespace XLua.CSObjectWrap
{
    ...
    public class UGFrameworkRuntimeFTimerListBehaviorWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UGFramework.Runtime.FTimerListBehavior);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new UGFramework.Runtime.FTimerListBehavior();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UGFramework.Runtime.FTimerListBehavior constructor!");
        ...
        static int _m_AddTimer(RealStatePtr L)
        {
		    try {
                ...
                UGFramework.Runtime.FTimerListBehavior gen_to_be_invoked = (UGFramework.Runtime.FTimerListBehavior)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_Instance(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, UGFramework.Runtime.FTimerListBehavior.Instance);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
