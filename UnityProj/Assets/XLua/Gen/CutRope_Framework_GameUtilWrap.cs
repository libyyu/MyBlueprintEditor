...
namespace XLua.CSObjectWrap
{
    ...
    public class CutRopeFrameworkGameUtilWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(CutRope.Framework.GameUtil);
        ...
        {
            return LuaAPI.luaL_error(L, "CutRope.Framework.GameUtil does not have a constructor!");
        }
        ...
        static int _m_IsEditorEnv_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = CutRope.Framework.GameUtil.IsEditorEnv(  );
        ...
        static int _m_IsWXEnv_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = CutRope.Framework.GameUtil.IsWXEnv(  );
                        LuaAPI.lua_pushboolean(L, gen_ret);
        ...
        static int _m_IsWebGLEnv_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = CutRope.Framework.GameUtil.IsWebGLEnv(  );
                        LuaAPI.lua_pushboolean(L, gen_ret);
        ...
        static int _m_CreateDirectory_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    CutRope.Framework.GameUtil.CreateDirectory( _dir );
        ...
        static int _m_CreateDirectoryForFile_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    CutRope.Framework.GameUtil.CreateDirectoryForFile( _filepath );
		    ...
		    try {
                ...
                
                {
                    string _dir = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = CutRope.Framework.GameUtil.IsDirectoryExist( _dir );
                        LuaAPI.lua_pushboolean(L, gen_ret);
        ...
        static int _m_ToHexString_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    string _sep = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = CutRope.Framework.GameUtil.ToHexString( _bytes, _sep );
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    byte[] _bytes = LuaAPI.lua_tobytes(L, 1);
                        ...
                        var gen_ret = CutRope.Framework.GameUtil.ToHexString( _bytes );
                        LuaAPI.lua_pushstring(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to CutRope.Framework.GameUtil.ToHexString!");
        ...
        static int _m_ToBytesString_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    string _sep = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = CutRope.Framework.GameUtil.ToBytesString( _bytes, _sep );
                        LuaAPI.lua_pushstring(L, gen_ret);
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    byte[] _bytes = LuaAPI.lua_tobytes(L, 1);
                        ...
                        var gen_ret = CutRope.Framework.GameUtil.ToBytesString( _bytes );
                        LuaAPI.lua_pushstring(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to CutRope.Framework.GameUtil.ToBytesString!");
        ...
        static int _m_IsPointerOverUIObject_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 0) 
                {
                        ...
                        var gen_ret = CutRope.Framework.GameUtil.IsPointerOverUIObject(  );
                        LuaAPI.lua_pushboolean(L, gen_ret);
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Canvas>(L, 1)&& translator.Assignable<UnityEngine.Vector2>(L, 2)) 
                {
                    ...
                    UnityEngine.Vector2 _screenPosition;translator.Get(L, 2, out _screenPosition);
                        ...
                        var gen_ret = CutRope.Framework.GameUtil.IsPointerOverUIObject( _canvas, _screenPosition );
                        LuaAPI.lua_pushboolean(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to CutRope.Framework.GameUtil.IsPointerOverUIObject!");
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = CutRope.Framework.GameUtil.LoadTexture2DFromFile( _path );
