...
namespace XLua.CSObjectWrap
{
    ...
    public class UGFrameworkRuntimeUILuaBehaviourWrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new UGFramework.Runtime.UILuaBehaviour();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UGFramework.Runtime.UILuaBehaviour constructor!");
