...
namespace UGFramework.Runtime
{
    ...
    namespace BlueprintRuntime
    {
        ...
        public sealed class BPContext
        {
            ...
            public void SetVariableString(string name, string val) =>
                Native.BP_CtxSetVariableString(_ctx, name, val ?? "");
        ...
        public sealed class BPRunner : IDisposable
        {
            ...
            public int ActiveTimerCount
            {
                ...
                {
                    ThrowIfDisposed();
                    return Native.BP_GetActiveTimerCount(_handle);
                }
            }
            ...
            public bool HasPendingWork
            {
                ...
                {
                    ThrowIfDisposed();
                    return Native.BP_HasPendingWork(_handle) != 0;
                }
            }
            ...
            public long GetVariableInt(string name)
            {
                ThrowIfDisposed();
                return Native.BP_GetVariableInt(_handle, name);
            }

            public double GetVariableFloat(string name)
            {
                ThrowIfDisposed();
                return Native.BP_GetVariableFloat(_handle, name);
            }

            public bool GetVariableBool(string name)
            {
                ThrowIfDisposed();
                return Native.BP_GetVariableBool(_handle, name) != 0;
            }
            ...
            public bool IsLoggingEnabled
            {
                ...
                {
                    ThrowIfDisposed();
                    return Native.BP_IsLoggingEnabled(_handle) != 0;
                }
            }
        ...
        public sealed class BPBlueprintMeta : IDisposable
        {
            ...
            internal BPBlueprintMeta(IntPtr handle)
            {
                _handle = handle;
            }
            ...
            public string Name
            {
                get
                {
                    ...
                    try
                    {
                        int n = Native.BP_MetaGetName(_handle, buf, BufSize);
                        return n > 0 ? Marshal.PtrToStringUTF8(buf, n) : "";
                    }
                    finally
                    {
            ...
            public string Version
            {
                get
                {
                    ...
                    try
                    {
                        int n = Native.BP_MetaGetVersion(_handle, buf, BufSize);
                        return n > 0 ? Marshal.PtrToStringUTF8(buf, n) : "";
                    }
                    finally
                    {
...
//#endif
    ...
    }//End Namespace BlueprintRuntime
