...
// FireConnectedNode + PauseRunner moved to BlueprintRunner_ExecutionContext.cpp
...
// Timer helpers + Log/Print/Delay + RunAsync + SetTimer + ActivateOutputFlow + MarkDownstreamAsHandled
// moved to BlueprintRunner_ExecutionContext.cpp
...
// ============================================================================
// EvaluateConditionPin moved to BlueprintRunner_ExecutionContext.cpp

// Lua extension methods (LoadExtensionScript / EnsureScriptEngine / TickScriptExtensions / ...)
// have been moved to BlueprintRunner_Lua.cpp to keep this file focused on the core runtime.
