    ...
    BlueprintRunner& runner)
{
    ...
    // ========================================================================
    handlers["Random.SetSeed"] = [&runner](ExecutionContext& ctx) -> bool {
    ...
    // ========================================================================
    handlers["Random.Float"] = [&runner](ExecutionContext& ctx) -> bool {
    ...
    // ========================================================================
    handlers["Random.Int"] = [&runner](ExecutionContext& ctx) -> bool {
    ...
    // ========================================================================
    handlers["Random.Bool"] = [&runner](ExecutionContext& ctx) -> bool {
    ...
    // ========================================================================
    handlers["Random.WeightedChoice"] = [&runner](ExecutionContext& ctx) -> bool {
    ...
    // ========================================================================
    handlers["Random.Shuffle"] = [&runner](ExecutionContext& ctx) -> bool {
    ...
    // ========================================================================
    handlers["Random.Vec2"] = [&runner](ExecutionContext& ctx) -> bool {
    ...
    // ========================================================================
    handlers["Random.PickFromArray"] = [&runner](ExecutionContext& ctx) -> bool {
        auto arr  = ctx.GetInputValue("Array");
    ...
    // ========================================================================
    handlers["GameTimer.Tick"] = [&runner](ExecutionContext& ctx) -> bool {
    ...
    // ========================================================================
    handlers["GameTimer.Reset"] = [&runner](ExecutionContext& ctx) -> bool {
        std::string key = ctx.GetInputValue("Key").asString();
        if (key.empty()) key = "default";
    ...
    // ========================================================================
    handlers["GameTimer.Get"] = [&runner](ExecutionContext& ctx) -> bool {
        std::string key = ctx.GetInputValue("Key").asString();
        if (key.empty()) key = "default";
    ...
    // 输出: EntityId(String)
    // ========================================================================
    handlers["Entity.Create"] = [&runner](ExecutionContext& ctx) -> bool {
    ...
    // ========================================================================
    handlers["Entity.Destroy"] = [&runner](ExecutionContext& ctx) -> bool {
    ...
    // ========================================================================
    handlers["Entity.IsAlive"] = [&runner](ExecutionContext& ctx) -> bool {
        std::string eid = ctx.GetInputValue("EntityId").asString();
    ...
    // ========================================================================
    handlers["Tag.Add"] = [&runner](ExecutionContext& ctx) -> bool {
        std::string eid = ctx.GetInputValue("EntityId").asString();
    ...
    // Tag.Remove — 移除标签
    // ========================================================================
    handlers["Tag.Remove"] = [&runner](ExecutionContext& ctx) -> bool {
        std::string eid = ctx.GetInputValue("EntityId").asString();
        std::string tag = ctx.GetInputValue("Tag").asString();
        std::string key = "__tags_" + eid;
        auto tags = runner.GetVariable(key);
    ...
    // Tag.Has — 检查实体是否有指定标签
    // ========================================================================
    handlers["Tag.Has"] = [&runner](ExecutionContext& ctx) -> bool {
        std::string eid = ctx.GetInputValue("EntityId").asString();
        std::string tag = ctx.GetInputValue("Tag").asString();
    ...
    // ========================================================================
    handlers["Tag.GetAll"] = [&runner](ExecutionContext& ctx) -> bool {
        std::string eid = ctx.GetInputValue("EntityId").asString();
        auto tags = runner.GetVariable("__tags_" + eid);
    ...
    // ========================================================================
    handlers["Inventory.Add"] = [&runner](ExecutionContext& ctx) -> bool {
    ...
    // ========================================================================
    handlers["Inventory.Remove"] = [&runner](ExecutionContext& ctx) -> bool {
        std::string slotId = ctx.GetInputValue("SlotId").asString();
        if (slotId.empty()) slotId = "default";
        std::string itemId = ctx.GetInputValue("ItemId").asString();
        int64_t qty = std::max(int64_t(0), ctx.GetInputValue("Quantity").asInt());
    ...
    // ========================================================================
    handlers["Inventory.GetQuantity"] = [&runner](ExecutionContext& ctx) -> bool {
        std::string slotId = ctx.GetInputValue("SlotId").asString();
        if (slotId.empty()) slotId = "default";
        std::string itemId = ctx.GetInputValue("ItemId").asString();
    ...
    // ========================================================================
    handlers["Inventory.GetAll"] = [&runner](ExecutionContext& ctx) -> bool {
        std::string slotId = ctx.GetInputValue("SlotId").asString();
        if (slotId.empty()) slotId = "default";
    ...
    // ========================================================================
    handlers["Inventory.Clear"] = [&runner](ExecutionContext& ctx) -> bool {
        std::string slotId = ctx.GetInputValue("SlotId").asString();
        if (slotId.empty()) slotId = "default";
        auto list = runner.GetVariable("__inv_list_" + slotId);
        for (size_t i = 0; i < list.arraySize(); ++i)
