...
namespace BlueprintRuntime
{
    ...
    public sealed class BPRunner : IDisposable
    {
        ...
        // or call ClearAllHandlers() during shutdown.
        // ─────────────────────────────────────────────────────────────────────
    ...
    public class BlueprintBehaviour : MonoBehaviour
    {
        ...
        protected virtual void Awake()
        {
            ...
            // Note: registration is process-global; only call once across the
            // lifetime of the app (re-registering is safe but redundant).
            RegisterNodes();
        ...
        ///
        /// Note: BPRunner.RegisterNodeDef / RegisterHandler are static and
        /// register process-globally. You only need to register each id once
        /// per process (typically on the first BlueprintBehaviour Awake);
        /// subsequent registrations are idempotent overwrites.
        ///
        /// Example:
        ...
        ///   }
        /// </summary>
        protected virtual void RegisterNodes() { }
    }
}
